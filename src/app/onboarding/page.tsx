  ...
  if (isLoading) {
    return (
      <div className="h-screen flex justify-center items-center flex-col">
        <div className="loader-dot mb-4"></div>
        <div className="text-bw-darkest">Finding the best occupation suited for you...</div>
      </div>
    );
  }
  return (
  ...
  return (
    <div className="relative flex-1 h-screen flex flex-col justify-between overflow-clip px-6 py-6">
      <div
        ...
        `}
      ></div>
      <div className={`absolute bg-bw-darker rounded-full size-64 bottom-24 -left-32 transition-all duration-300`}></div>
  ...
  return (
    <div className="relative flex-1 black flex flex-col justify-between overflow-clip">
      <div
        ...
        `}
      ></div>
      <div className={`absolute bg-bw-darker rounded-full size-96 bottom-36 -left-32 transition-all duration-300`}></div>
...
function CurrentJob({ onDone }) {
  ...
  return (
    <div className="relative flex-1 h-[calc(100vh-10px)] max-h-screen black flex flex-col justify-between overflow-clip">
      ...
      ></div>
      <div className={`absolute rounded-full size-64 bottom-24 -left-32 transition-all duration-300`} style={{ backgroundColor: color2 }}></div>
        ...
        <div className="mt-24">
          <AnimatePresence>
            <motion.div
              ...
              className="-ml-8"
            >
              <Lottie loop animationData={lottie} play style={{ width: 420, height: 420 }} />
            </motion.div>
          </AnimatePresence>
        </div>
      </div>
...
function Tree({ className }) {
  return (
    <>
      <svg width="94" height="99" viewBox="0 0 94 99" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <path
          ...
          fill="#3C7A6F"
        />
        <path d="M42.0906 42.6833H27.5857C16.0529 42.6833 6.70366 33.3341 6.70366 21.8013V20.8821C6.70366 9.34929 16.0529 7.62939e-06 27.5857 7.62939e-06H44.588V31.5201H42.5014L42.0906 42.6833Z" fill="#2C5A58" />
        <path
          ...
          fill="#52988D"
        />
        <path d="M19.9625 70.7854H10.9973C4.92375 70.7854 0 65.8616 0 59.7881V59.3044C0 53.2304 4.92375 48.3074 10.9973 48.3074H19.9625V59.4232L19.2733 58.9638L17.9602 60.7853L19.9625 62.3447V70.7854Z" fill="#3C7A6F" />
        <path
          ...
          fill="#52988D"
        />
        <path d="M72.5002 48.7875L71.3362 46.8668L48.1309 59.7813L47.0902 31.5201H42.5014L40.9589 73.4184L19.2734 58.9638L17.9604 60.7852L40.7694 78.5458L40.0346 98.5001H49.5577L48.3118 64.6855L72.5002 48.7875Z" fill="#784663" />
        <path d="M52.5658 57.313C50.3187 55.0839 48.9264 51.993 48.9264 48.5777V48.0359C48.9264 41.2405 54.4367 35.7314 61.2321 35.7314H71.1847V46.9512L52.5658 57.313Z" fill="#3C7A6F" />
        <path d="M44.949 98.5001H40.1884L42.6548 31.5201H45.2287L44.949 98.5001Z" fill="#4F3B56" />
      </svg>
    </>
  );
}
...
function Sofa({ className }) {
  return (
    <>
      <svg width="132" height="62" viewBox="0 0 132 62" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <path d="M85.0331 3.77197H48.5718V32.6595H85.0331V3.77197Z" fill="#FF7E90" />
        <g opacity="0.4">
          <path d="M85.0331 3.77197H48.5718V32.6595H85.0331V3.77197Z" fill="black" />
        </g>
        <path d="M4.03355 18.2197C4.03355 18.2197 9.79365 16.025 13.0551 15.8944C16.3165 15.7641 18.0124 18.047 18.5342 19.0255C19.0561 20.004 19.5779 27.9618 19.5779 27.9618V59.2717H13.6752L4.03355 18.2197Z" fill="#FF7E90" />
        <g opacity="0.4">
          <path d="M4.03355 18.2197C4.03355 18.2197 9.79365 16.025 13.0551 15.8944C16.3165 15.7641 18.0124 18.047 18.5342 19.0255C19.0561 20.004 19.5779 27.9618 19.5779 27.9618V59.2717H13.6752L4.03355 18.2197Z" fill="black" />
        </g>
        <path
          ...
          fill="#FF7E90"
        />
        <path d="M127.966 18.2197C127.966 18.2197 122.206 16.025 118.945 15.8944C115.684 15.7641 113.988 18.047 113.466 19.0255C112.944 20.004 112.422 27.9618 112.422 27.9618V59.2717H118.325L127.966 18.2197Z" fill="#FF7E90" />
        <g opacity="0.4">
          <path d="M127.966 18.2197C127.966 18.2197 122.206 16.025 118.945 15.8944C115.684 15.7641 113.988 18.047 113.466 19.0255C112.944 20.004 112.422 27.9618 112.422 27.9618V59.2717H118.325L127.966 18.2197Z" fill="black" />
        </g>
        <path
          ...
          fill="#FF7E90"
        />
        <path d="M118.319 59.6455H13.6754C13.6086 53.9118 13.7881 47.3585 13.8425 40.3624H118.319V59.6455Z" fill="#FF7E90" />
        <path
        ...
        />
        <g opacity="0.3">
          <path d="M14.1517 41.0734C24.1584 42.6742 34.8139 44.1131 44.9477 44.0362C51.6578 43.9855 59.2759 43.5456 65.5834 41.2555C49.388 41.5992 32.1528 41.4996 14.1517 41.0734Z" fill="black" />
        </g>
        <g opacity="0.2">
          <path
        ...
        />
        <g opacity="0.3">
          <path d="M117.858 40.9543C107.8 41.9206 96.8367 43.9893 86.7029 43.9126C79.9928 43.8619 72.5772 42.7159 66.3211 41.0604C77.4044 41.6316 97.4601 41.1416 117.858 40.9543Z" fill="black" />
        </g>
        <g opacity="0.2">
          <path
