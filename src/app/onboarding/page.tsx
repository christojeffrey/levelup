...
function ThisOrThat({ onDone }) {
  ...
  return (
    <div className="relative flex-1 black flex flex-col justify-between overflow-clip">
      <div className="text-3xl mt-24 mx-4">What's your current occupation?</div>
      <div className="flex justify-around h-full">
        <div className="bg-[#E6E4D7] rounded-xl relative m-2 w-1/2 p-4 h-48 flex flex-col justify-center items-center border-black border-2 cursor-pointer" onClick={handleClick}>
          <Sofa className="" />
  ...
  return (
    <div className="relative flex-1 black flex flex-col justify-between overflow-clip">
      ...
      <div
        ...
        `}
      ></div>
      <div className={`absolute bg-[${color2}] rounded-full size-64 bottom-12 -left-32 transition-all duration-300`}></div>
